...
public class CurrentReservationActivity extends AppCompatActivity {
    ...
    public void checkOutAllFunc(View view) {
        ...
        handler.post(() -> {
            ...
            data[0] = number;
            PutData putData = new PutData("http://192.168.1.9/hotel/checkoutall.php", "POST", field, data);
            if (putData.startPut()) {
    ...
    public void checkOut(View view) {
        ...
        handler.post(() -> {
            ...
            String[] data = new String[1];
            data[0] = number;
            PutData putData = new PutData("http://192.168.1.9/hotel/checkout.php", "POST", field, data);
            if(putData.startPut()) {
                if(putData.onComplete()) {
                    String result = putData.getResult();
                    if(result.equals("checkout Success")){
